...
@Component({
  selector: 'app-web-categorywise-tv',
  templateUrl: './web-categorywise-tv.component.html',
  styleUrls: ['./web-categorywise-tv.component.css']
})
export class WebCategorywiseTvComponent implements OnInit {
