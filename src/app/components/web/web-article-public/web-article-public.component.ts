...
@Component({
  selector: 'app-web-article-public',
  templateUrl: './web-article-public.component.html',
  styleUrls: ['./web-article-public.component.css']
})
export class WebArticlePublicComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this._apiService.loggedIn()){
      ...
      // this._apiService.getAllCategoryArticles(9).subscribe(ret=>{
      //   let $ret = ret.ret;
      //   if($ret.code == 1){
      //     this.categorywiseArticle = $ret.data;
      //     this.categoryCount = Math.floor(this.categorywiseArticle.length / 2);
      //     this.loading = false;
      //   }else{
      //     this.categorywiseArticle = [];
