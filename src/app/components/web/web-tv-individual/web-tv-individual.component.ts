...
@Component({
  selector: 'app-web-tv-individual',
  templateUrl: './web-tv-individual.component.html',
  styleUrls: ['./web-tv-individual.component.css']
})
export class WebTvIndividualComponent implements OnInit {
...
console.log(this.tvIndividual)
            ...
            this.tvIndividual.path = this.safeUrl(this.tvIndividual.path + "?autoplay=1;autoplay=1&mute=1");
        ...
        // this._apiService.getTv(1,13).subscribe(ret=>{
        //   let $ret = ret.ret;
        //   if($ret.code == 1){
        //     this.latestTv = $ret.data[0];
        //     try{
        //       this.recentTvs = $ret.data.slice(1);
        //       for(let i=0; i<this.recentTvs.length; i++){
        //         this.recentTvs[i].path = this.safeUrl(this.recentTvs[i].path);
        //       }
        //     }
        ...
        // this._apiService.getTv(2,4).subscribe(ret=>{
        //   let $ret = ret.ret;
        //   if($ret.code == 1){
        //     this.trendingTvs = $ret.data;
        //   }
        // },err=>{
        // });
      });
