...
@Component({
  selector: 'app-web-categorywise-radio',
  templateUrl: './web-categorywise-radio.component.html',
  styleUrls: ['./web-categorywise-radio.component.css']
})
export class WebCategorywiseRadioComponent implements OnInit {
