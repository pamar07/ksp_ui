...
@Component({
  selector: 'app-web-article-latest',
  templateUrl: './web-article-latest.component.html',
  styleUrls: ['./web-article-latest.component.css'],
  providers: [DatePipe]
})
export class WebArticleLatestComponent implements OnInit {
