...
@Component({
  selector: 'app-web-post-individual',
  templateUrl: './web-post-individual.component.html',
  styleUrls: ['./web-post-individual.component.css']
})
export class WebPostIndividualComponent implements OnInit {
  ...
  getAdvertisement(){
   ...
   //console.log("advertisement 1",this.advertisement);
    ...
    deleteSocialPost(post_id,post_title){
      let dialogRef = this.dialog.open(PostAlterPostIndividualPageDialog,{data:"You are going to delete the post <br/> <b>" + post_title + "</b>"});
    ...
    saveEditedPost(){
      if(this.editedPostTitle!='' && this.editedPostContent!=''){
        let dialogRef = this.dialog.open(PostAlterPostIndividualPageDialog,{data:"You are going to update the post <br/> <b>" + this.editedPostTitle + "</b>"});
        dialogRef.afterClosed().subscribe(result => {
          if(result == true){
...
export class PostCommentDialog {
...
export class PostAlterPostIndividualPageDialog {
 constructor(
