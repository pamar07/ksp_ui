...
@Component({
  selector: 'app-web-ksp-awards',
  templateUrl: './web-ksp-awards.component.html',
  styleUrls: ['./web-ksp-awards.component.css']
})
export class WebKspAwardsComponent implements OnInit {
