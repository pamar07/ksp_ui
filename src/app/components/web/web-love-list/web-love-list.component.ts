...
@Component({
  selector: 'app-web-love-list',
  templateUrl: './web-love-list.component.html',
  styleUrls: ['./web-love-list.component.css'],
  providers: [DatePipe]
})
export class WebLoveListComponent implements OnInit {
