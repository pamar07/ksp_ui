...
@Component({
    selector: 'app-mobile-paymentFinal',
    templateUrl: './mobile-paymentFinal.component.html',
    styleUrls: ['./mobile-paymentFinal.component.css'],
    providers: [DatePipe]
  })
  export class MobilePaymentFinal implements OnInit {
    redirecturl: any;
    bundle_id: any;
    bundleId:any;
