...
@Component({
  selector: 'app-mobile-article-public',
  templateUrl: './mobile-article-public.component.html',
  styleUrls: ['./mobile-article-public.component.css']
})
export class MobileArticlePublicComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this._apiService.loggedIn()){
      this._router.navigate(['/article-user']);
    }
    else{
      this.carouselOne = {
      ...
      if(localStorage.getItem("selectedAges")==null && localStorage.getItem("selectedCities")==null){
