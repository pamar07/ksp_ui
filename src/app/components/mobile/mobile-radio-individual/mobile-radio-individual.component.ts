...
@Component({
  selector: 'app-mobile-radio-individual',
  templateUrl: './mobile-radio-individual.component.html',
  styleUrls: ['./mobile-radio-individual.component.css']
})
export class MobileRadioIndividualComponent implements OnInit {
        ...
        this._apiService.getIndividualRadio(this.id,12).subscribe(ret=>{
          ...
          if($ret.code == 1){
            ...
            try{
              ...
              this.radioIndividual.content = this.radioIndividual.content.split("width:").join("width:100%;");
              this.radioIndividual.content = this.radioIndividual.content.split("height:").join("height:auto;");
              this.radioIndividual.content = this.radioIndividual.content.split(" width=").join(" width=100%");
              this.radioIndividual.content = this.radioIndividual.content.split(" height=").join(" height=auto");
...
export class MobileRadioDialog {
