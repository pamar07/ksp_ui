...
@Component({
  selector: 'app-mobile-article-most-popular',
  templateUrl: './mobile-article-most-popular.component.html',
  styleUrls: ['./mobile-article-most-popular.component.css']
})
export class MobileArticleMostPopularComponent implements OnInit {
