...
@Component({
  selector: 'app-mobile-bookmark-list',
  templateUrl: './mobile-bookmark-list.component.html',
  styleUrls: ['./mobile-bookmark-list.component.css']
})
export class MobileBookmarkListComponent implements OnInit {
