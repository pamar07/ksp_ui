...
@Component({
  selector: 'app-mobile-camp-all',
  templateUrl: './mobile-camp-all.component.html',
  styleUrls: ['./mobile-camp-all.component.css'],
  providers: [DatePipe]
})
export class MobileCampAllComponent implements OnInit {
