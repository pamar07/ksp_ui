...
@Component({
  selector: 'app-mobile-article-most-loved',
  templateUrl: './mobile-article-most-loved.component.html',
  styleUrls: ['./mobile-article-most-loved.component.css']
})
export class MobileArticleMostLovedComponent implements OnInit {
