...
@Component({
  selector: 'app-mobile-custom-result',
  templateUrl: './mobile-custom-result.component.html',
  styleUrls: ['./mobile-custom-result.component.css']
})
export class MobileCustomResultComponent implements OnInit {
