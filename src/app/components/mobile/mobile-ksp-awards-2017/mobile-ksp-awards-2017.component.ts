...
@Component({
  selector: 'app-mobile-ksp-awards-2017',
  templateUrl: './mobile-ksp-awards-2017.component.html',
  styleUrls: ['./mobile-ksp-awards-2017.component.css']
})
export class MobileKspAwards2017Component implements OnInit {
